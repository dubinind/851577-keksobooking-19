...
//     var minX = window.map.mapPins.clientLeft;
//     var maxX = window.map.mapPins.clientWidth + minX;
//     return {
...
//     window.map.mapPins.addEventListener('mousedown', window.pin.onPinMouseDown);
//     window.map.mapPins.addEventListener('keydown', window.pin.onPinKeyDown);
//   };
